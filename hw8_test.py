...
def test_process(config):
    ...
    # 儲存結果
    print("Writing result in {}...".format(sys.argv[2]))
    if not os.path.isdir(os.path.split(sys.argv[2])[0]):
        os.path.makedirs(os.path.split(sys.argv[2])[0])
...
class configurations(object):
    def __init__(self):
        ...
        self.load_model_path = './model_AT_BS'
